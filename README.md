...
[这个是直接下载得到的数据信息。就是如下图所示](https://tianchi.aliyun.com/competition/entrance/532420/information)。

![这是图片](./project_img/sourcedata.png)
...
![这是产生向量的数据内容](./project_img/生成数据.png)
